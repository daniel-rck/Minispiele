...
<p align="center">
  <strong>30 Browser-Minispiele. Lokal, ohne Account, ohne Tracking.</strong>
</p>
...
30 Spiele in sechs Kategorien — **Logik & Denksport** (13) · **Wort & Sprache** (4) · **Action & Arcade** (4) · **Gehirntraining** (6) · **Karten** (1) · **Werkzeuge** (2). Vollständige Liste in [`GAMES.md`](./GAMES.md). Quelle der Wahrheit ist [`src/lib/gamesCatalog.ts`](./src/lib/gamesCatalog.ts).
