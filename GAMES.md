...
Aktueller Stand kommt aus [`src/lib/gamesCatalog.ts`](./src/lib/gamesCatalog.ts) — das ist die Quelle der Wahrheit. Diese Übersicht dient nur zum schnellen Scrollen.
